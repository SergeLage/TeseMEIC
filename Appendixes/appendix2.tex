...
\end{figure}
\newpage
\item After finding the maximum frequency Hill-Climbing finds the next minimum frequency to represent the maximum velocity value of the fishing activity.
\begin{figure}[H]
    \centering
...
\item Remove values larger that the maximum velocity value found in the last step.
\begin{figure}[H]
    \centering
    \includegraphics[trim=0 80 0 80,height=0.45\linewidth]{Chapters/img/hist_vessel2.pdf}
    \caption{Remove values referring to traveling}
    \label{fig:app_b_5}
\end{figure}
